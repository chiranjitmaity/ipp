...
export const TOOLS: Tool[] = [
    ...
    },
    {
        ...
        description: 'Download YouTube videos in MP4 format or extract MP3 audio.',
        category: TOOL_CATEGORIES.MOBILE_SOCIAL,
        icon: Download,
    ...
    },
    {
        ...
        category: TOOL_CATEGORIES.MOBILE_SOCIAL,
        icon: Download,
        href: '/tools/facebook-video-download',
    },
    {
        id: 'tiktok-video-download',
        title: 'TikTok Downloader',
        description: 'Save TikTok videos without the watermark directly to your device.',
        category: TOOL_CATEGORIES.MOBILE_SOCIAL,
        icon: Download,
